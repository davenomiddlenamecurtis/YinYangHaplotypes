...
int depthParams::readParms(int argc, char* argv[])
{
	FILE* fp[MAXDEPTH];
	int argNum,depth;
	char arg[2000];
...
int depthParams::getNextArg(char* nextArg, int argc, char* argv[], FILE* fp[MAXDEPTH], int* depth, int* argNum)
{
	char* ptr;
	int ch;
	*nextArg = '\0';
